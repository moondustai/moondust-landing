  ...
  return (
    <>
      ...
      <p className="mt-4 text-sm/6 text-gray-300">
        Sprinkle images, text, or video based advertisements into your existing
        ChatGPT integration. Avoid ad-fatigue and engage your customers with exciting new content.
      </p>
      <SignUpForm />
...
export function IntroFooter() {
  return (
    <p className="flex items-baseline gap-x-2 text-[0.8125rem]/6 text-gray-500">
      Brought to you by{' '}
      <IconLink href="https://twitter.com/moondustai" icon={TwitterIcon} compact large>
        moondustai
      </IconLink>
    </p>
  )
