...
export function SignUpForm() {
  ...
  return (
    <PopupButton id="RamM3W1f" className="mt-8 group relative isolate flex-none rounded-md py-1.5 text-[0.8125rem]/6 font-semibold text-white pl-2.5 pr-[calc(9/16*1rem)]">
